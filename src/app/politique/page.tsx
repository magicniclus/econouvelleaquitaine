      ...
      <main className="min-h-screen flex justify-center items-center flex-col bg-slate-50">
        ...
        <div className="mx-auto max-w-7xl  px-6 lg:px-8 pb-10">
          ...
          <p className="text-nomral font-normal mt-5">
            Bienvenue sur TeraBois. Nous nous engageons à protéger votre vie
            privée et à respecter les normes de protection des données
            personnelles en vigueur.
          </p>
          <p className="text-nomral font-normal mt-5">
          ...
          <p className="text-nomral font-normal mt-5">
            TeraBois collecte des informations que vous nous fournissez lorsque
            vous remplissez des formulaires sur notre site web, par exemple
            lorsque vous demandez un devis pour une rénovation. Les informations
            collectées peuvent inclure votre nom, adresse e-mail, numéro de
            téléphone, adresse et autres détails relatifs à votre projet de
            rénovation.
          </p>
          <h2 className="text-2xl font-bold tracking-tight text-gray-800 sm:text-3xl  mt-16">
          ...
          <p className="text-nomral font-normal mt-5">
            TeraBois utilise les informations recueillies pour vous fournir des
            devis précis, répondre à vos questions, communiquer avec vous au
            sujet de nos services, et améliorer nos offres et services.
          </p>
          <h2 className="text-2xl font-bold tracking-tight text-gray-800 sm:text-3xl  mt-16">
            Partage des informations
          </h2>
          <p className="text-nomral font-normal mt-5">
            TeraBois est une entreprise qui récolte des leads pour son propre
            compte et ne partage, ne vend, ni n&apos;échange vos informations
            personnelles avec des tiers, sauf si la loi l&apos;exige, dans le
            cadre d&apos;une transaction d&apos;entreprise, ou si nous avons
            obtenu votre consentement préalable.
          </p>
          <h2 className="text-2xl font-bold tracking-tight text-gray-800 sm:text-3xl  mt-16">
            Sécurité des informations
          </h2>
          <p className="text-nomral font-normal mt-5">
            TeraBois utilise des mesures de sécurité appropriées pour protéger
            contre la perte, l&apos;abus et l&apos;altération des données
            utilisées par notre système. Cependant, aucune transmission de
            données sur Internet n&apos;est 100% sécurisée, et bien que nous
            nous efforçons de protéger vos informations personnelles, nous ne
          ...
          <p className="text-nomral font-normal mt-5">
            ...
            contacter à contact@terabois.fr.
          </p>
          <h2 className="text-2xl font-bold tracking-tight text-gray-800 sm:text-3xl  mt-16">
            Changements à cette politique de confidentialité
          </h2>
          <p className="text-nomral font-normal mt-5">
            TeraBois se réserve le droit de modifier cette politique de
            ...
            pour être informé de toute modification.
          </p>
          <p className="text-nomral font-normal mt-5">
